...
public class Controlador {
    ...
    public Lote getLoteActual() throws Exception {
     ...
     */
    public void cambiarAAceptado(Calendar fechaProduccion) throws StateException {
    ...
    public void crearNuevoPedido(Calendar fechaPedido, String tipoMaquina, int cantProducir,
                                 Calendar fechaSolicitadaVentas) throws Exception {
        if (Verificaciones.verificaTipoProducto(tipoMaquina)) {
            ...
            if (Verificaciones.verificaTipoCodigo(maquina) && Verificaciones.verificaNumeroPedido(numeroPedido) &&
                fechaPedido != null && Verificaciones.verificaCantProduccion(cantProducir) &&
                fechaSolicitadaVentas != null) {
                Pedido nuevo =
                    new Pedido(numeroPedido, fechaPedido, fechaSolicitadaVentas, maquina, tipoMaquina, cantProducir);
                pedidos.agregarNuevo(nuevo);
                /*Agrega el nuevo pedido como pedido actual*/
                this.pedidoActual = nuevo;
            } else
     ...
     * @throws Exception
     */
    public void generarLote() throws Exception {
    ...
    public void borrarMaterial(String codigo) throws Exception {
     ...
     * @throws Exception
     */
    public Observacion crearObservacion(String temaIngresado, String texto) throws Exception {
